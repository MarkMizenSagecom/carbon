...
<Preview>
  <Story name="confirm - disableConfirm" parameters={{ chromatic: { disable: true }}}>
    {() => {
      const [isOpen, setIsOpen] = useState(false);
      return (
        <>
...
<Preview>
  <Story name="confirm - disableCancel" parameters={{ chromatic: { disable: true }}}>
    {() => {
      const [isOpen, setIsOpen] = useState(false);
      return (
        <>
...
<Preview>
  <Story name="confirm - isLoadingConfirm" parameters={{ chromatic: { disable: true }}}>
    {() => {
      const [isOpen, setIsOpen] = useState(false);
      return (
        <>
