...
<Preview>
  <Story name="with Tooltip color overrides">
    <div style={ { margin: '64px 300px' } }>
      <Help tooltipBgColor="lightblue" tooltipFontColor="black" isFocused={true}>
...
<Preview>
  <Story name="with href" parameters={{ info: { disable: true }, chromatic: { disable: true }}}>
    <div style={ { margin: '64px' } }>
